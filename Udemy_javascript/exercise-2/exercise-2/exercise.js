...
const firstParagraphElement = document.body.children[2].childern[1];
console.log(firstParagraphElement);
//const thirdParagraphElement = document.body.children[2].childern[3];
const thirdParagraphElement =
  firstParagraphElement.nextElementSibiling.nextElementSibiling;
